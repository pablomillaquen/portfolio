...
<head>
    ...
    <meta property="og:image" content="{{ $seo['image'] ?? 'https://pablomillaquen.com/img/og_image.png' }}">
    ...
    <meta name="twitter:image" content="{{ $seo['image'] ?? 'https://pablomillaquen.com/img/og_image.png' }}">
